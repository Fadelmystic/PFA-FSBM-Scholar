...
# -*- coding: utf-8 -*-
"""
Chat Interactif CPU - Modèle FSBM LLaMA Fine-tuné
==================================================

Interface de chat interactive adaptée pour CPU (sans GPU CUDA).
"""
...
def print_header():
    ...
    print("=" * 60)
    print("🎓 FSBM SCHOLAR ASSISTANT - CHAT INTERACTIF (CPU)")
    print("=" * 60)
    print("🤖 Assistant IA fine-tuné pour les questions FSBM")
    print("💻 Mode CPU - Pas de GPU requis")
