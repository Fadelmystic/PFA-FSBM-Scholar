...
# -*- coding: utf-8 -*-
"""
Chat Simple CPU - Modèle FSBM LLaMA Fine-tuné
==============================================

Version simplifiée du chat pour éviter les problèmes d'attention mask.
"""
...
def print_header():
    ...
    print("=" * 60)
    print("🎓 FSBM SCHOLAR ASSISTANT - CHAT SIMPLE (CPU)")
    print("=" * 60)
    print("🤖 Assistant IA fine-tuné pour les questions FSBM")
    print("💻 Mode CPU - Version simplifiée")
...
def load_model():
    ...
    try:
        ...
        # Configuration simple du tokenizer
...
def generate_response_simple(model, tokenizer, prompt, max_tokens=100):
    """Générer une réponse avec approche simplifiée"""
    try:
        # Formater le prompt
        ...
        # Générer sans attention mask explicite
        with torch.no_grad():
...
def show_model_info():
    ...
    if os.path.exists(model_info_path):
        try:
            ...
            print(f"💻 Mode: CPU (version simplifiée)")
...
def interactive_chat():
    """Interface de chat interactive simplifiée"""
    print_header()
    ...
    print("🔧 Version simplifiée - Pas d'attention mask")
    print()
    ...
    while True:
        try:
            ...
            response = generate_response_simple(model, tokenizer, user_input)
